...
def optimiere_trajektorie(mittelpunkte, streckenbreite):
    """
...
if __name__ == "__main__":
    ...
    max_points = (len(center)) - 7  # Make sure we don't exceed array bounds
    ...
    for i in range(max_points):
        ...
        new_racing_line, current_speed = optimiere_trajektorie(center[lower_boundary:upper_boundary], 5.9)
